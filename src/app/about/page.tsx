      ...
      <div className="w-full mx-auto px-0">
        ...
        <article className="pb-6 lg:pb-6">
          <div className="grid lg:grid-cols-2 lg:gap-6 lg:px-24 py-0 lg:absolute">
            ...
            <div className="relative lg:bg-foreground lg:w-auto lg:px-8 -translate-y-8 pt-6">
              <div className="lg:px-0 lg:w-auto px-5 w-9/10 bg-foreground lg:bg-transparent pt-4 lg:pt-0">
                <div
                  className={`contentArea text-white text-xl leading-7`}
