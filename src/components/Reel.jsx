...
export default function Reel() {
  return (
    <div className="w-full m-0 p-0 border border-foreground group cursor-pointer bg-white/20 hover:bg-white/40 transition-colors duration-200 relative">
      <Image
        alt="White Lies"
        src="/images/white-lies-bloody-sunday.webp"
        fill
        className="object-cover mix-blend-overlay opacity-50 object-top"
        priority
      />
